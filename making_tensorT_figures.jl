function compute_Ts()
    ...
    return T11_true, T12_true, T22_true, ζD_filtered, ζDhat_filtered, trace_filtered, ζsqT, ζDT, ζDhat, T11_NN, T12_NN, T22_NN
...
T11_true, T12_true, T22_true, ζD_filtered, ζDhat_filtered, trace_filtered, ζsqT, ζDT, ζDhat, T11_NN, T12_NN, T22_NN = compute_Ts();
denom = SZB.grid.Δ^2 * SZB.grid.scale

## "True" versus NN (offline) T's
