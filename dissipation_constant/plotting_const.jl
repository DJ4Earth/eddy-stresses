...
function create_models()
    ...
    # onlineweights = load_object("./result_multistate_1:2:89initdaystart_1dayoptimization_initialweightsmulti3daystate_fewerinitconds_15iterations.jld2").solution;
