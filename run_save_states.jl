...
jldsave("coarsegrainedu_30days_dailysaves_071525.jld2", u=u)
jldsave("coarsegrainedv_30days_dailysaves_071525.jld2", v=v)
jldsave("coarsegrainedeta_30days_dailysaves_071525.jld2", eta=eta)

# Shr = ShallowWaters.run_model(output=true,
#         L_ratio=1,
#         g=9.81,
#         H=500,
#         wind_forcing_x="double_gyre",
...
#         Ndays=30,
#         initial_cond="ncfile",
#         initpath="./spinup_files/1024_postspinup_noslip_4days_073124/",
#         init_starti=1
# )