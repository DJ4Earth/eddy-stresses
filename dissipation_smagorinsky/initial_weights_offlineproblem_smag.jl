...
function InitWeightsModel{T}() where {T<:AbstractFloat}
    ...
    filteredstates = load_object("./dissipation_smagorinsky/spinup_files_newdissipation/1024_filtered_downsized_uveta_imfilter_90days_postspinup_smagdissipation_8hoursaves.jld2")
