function comp_u_v_eta_t(nx::Int, rhs::SWM_pde, params::Params, interp::Interps, grad::Derivatives, advec::Advection) 
...
function comp_u_v_eta_t(nx::Int, rhs::RHS_terms, params::Params, interp::Interps, grad::Derivatives, advec::Advection) 
