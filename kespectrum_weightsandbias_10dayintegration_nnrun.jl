...
function kespec2_compute_loss(Ndays, param_guess, data, data_steps)
...
function kespec2_compute_gradient(G, param_guess, data, data_steps, Ndays)
...
function kespec2_FG(F, G, param_guess, data, data_steps, Ndays)

    G === nothing || kespec2_compute_gradient(G, param_guess, data, data_steps, Ndays)
    F === nothing || return kespec2_compute_loss(Ndays, param_guess, data, data_steps)
...
function run_kespec2()
    ...
    fg!_closure(F, G, param_guess) = kespec2_FG(F, G, param_guess, data, data_steps, Ndays)
